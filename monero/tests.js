...
describe('monero chain', () => {
	...
	describe('prepare', () => {
		it('should load config', async () => {
			...
			D.bounce_cashin = 7 * Math.pow(10, CFG.assetAccuracy);
		...
		D,
		{
			fill: async (API, SIGN) => {
				let WS = {
					...
					W1 = API.Wallet.createPaperWallet(CFG.testnet),
					W2 = API.Wallet.createPaperWallet(CFG.testnet),
					W3 = API.Wallet.createPaperWallet(CFG.testnet),
					W4 = API.Wallet.createPaperWallet(CFG.testnet);
...
// 			let W1 = wallet.createPaperWallet(true),
// 				W2 = wallet.createPaperWallet(true),
// 				W3 = wallet.createPaperWallet(true),
// 				W4 = wallet.createPaperWallet(true);
